...
from runtime.operational_memory import OperationalMemoryStore, build_operational_memory_from_outputs
...
class GraphContext:
    ...
    def record(self, outputs: Dict[str, Any]) -> None:
        ...
        # Persist lightweight operational memory extracted from node outputs
        memory_entries = build_operational_memory_from_outputs(self.outputs)
        memory_store = OperationalMemoryStore(self.directory)
        memory_store.write_entries(memory_entries)
